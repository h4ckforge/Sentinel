    ...
    try:
        ...
        cur = conn.execute(
            ...
            (
                ...
                parsed["active_skill"],
                json.dumps(parsed["pending_actions"], ensure_ascii=False),
                json.dumps(parsed["explained_concepts"], ensure_ascii=False),
                json.dumps(parsed["findings"], ensure_ascii=False),
